...
GPU_TIER_CONFIGS = {
    ...
    "tier5": {  # 12-16GB
        ...
        "recommended_backend": "vllm",
        "offload_to_cpu_default": True,
        "offload_dit_to_cpu_default": False,  # 12GB cards hit severe VRAM contention with DiT resident — LM tokens drop from ~22/s to ~1.5/s and VAE decode balloons from ~4min to ~30min
        "quantization_default": True,
        "compile_model_default": True,
